...
export class Init1752745037148 implements MigrationInterface {
    name = 'Init1752745037148'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`workflow_tasks\` (\`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updatedAt\` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` timestamp(6) NULL, \`tenantId\` varchar(255) NOT NULL DEFAULT 'f1c59dda-1957-42f3-b80a-0848dbc2050f', \`id\` varchar(36) NOT NULL, \`workflowStepDefinitionId\` varchar(255) NOT NULL, \`workflowInstanceId\` varchar(255) NOT NULL, \`status\` enum ('APPROVE', 'REJECT', 'CANCEL', 'NEEDS_REVISION') NOT NULL, \`actedByUserId\` varchar(255) NULL, \`actedByRoleId\` varchar(255) NULL, \`actionDate\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`comments\` text NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`chart_of_accounts\` (\`id\` varchar(36) NOT NULL, \`accountCode\` varchar(255) NOT NULL, \`description\` text NULL, \`accountType\` varchar(100) NOT NULL, UNIQUE INDEX \`IDX_4cb7d4663a389456682a1c4f35\` (\`accountCode\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`budget_calendars\` (\`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updatedAt\` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` timestamp(6) NULL, \`tenantId\` varchar(255) NOT NULL DEFAULT 'f1c59dda-1957-42f3-b80a-0848dbc2050f', \`id\` varchar(36) NOT NULL, \`name\` varchar(50) NOT NULL, \`description\` text NULL, \`from\` timestamp NULL, \`to\` timestamp NULL, \`status\` varchar(255) NOT NULL DEFAULT 'Open', UNIQUE INDEX \`IDX_b8b0e0dc9227302b7676194b49\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`budget_plans\` (\`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updatedAt\` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` timestamp(6) NULL, \`tenantId\` varchar(255) NOT NULL DEFAULT 'f1c59dda-1957-42f3-b80a-0848dbc2050f', \`organizationalUnitId\` varchar(255) NOT NULL, \`id\` varchar(36) NOT NULL, \`calendarId\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`budget_plans_items\` (\`id\` varchar(36) NOT NULL, \`plan\` varchar(100) NOT NULL, \`description\` text NULL, \`amount\` decimal(15,2) NOT NULL, \`budgetPlanId\` varchar(255) NOT NULL, \`accountId\` varchar(255) NOT NULL, UNIQUE INDEX \`IDX_6c2d15be4ed959824ad8c606da\` (\`plan\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`workflow_tasks\` ADD CONSTRAINT \`FK_01a7addec613445c0546cfe7beb\` FOREIGN KEY (\`workflowStepDefinitionId\`) REFERENCES \`workflow_step_definitions\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`workflow_tasks\` ADD CONSTRAINT \`FK_82c7dfd058f5a9942881237791e\` FOREIGN KEY (\`actedByRoleId\`) REFERENCES \`roles\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`budget_plans\` ADD CONSTRAINT \`FK_199873cfc22a78da747a84e6344\` FOREIGN KEY (\`organizationalUnitId\`) REFERENCES \`organizational_units\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`budget_plans\` ADD CONSTRAINT \`FK_aebc4d211ef6721235e3d6fb610\` FOREIGN KEY (\`calendarId\`) REFERENCES \`budget_calendars\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`budget_plans_items\` ADD CONSTRAINT \`FK_7e21f7bc697977567a5eac4698d\` FOREIGN KEY (\`budgetPlanId\`) REFERENCES \`budget_plans\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`budget_plans_items\` ADD CONSTRAINT \`FK_9779795b1de6e3dc02d0edabe8f\` FOREIGN KEY (\`accountId\`) REFERENCES \`chart_of_accounts\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`budget_plans_items\` DROP FOREIGN KEY \`FK_9779795b1de6e3dc02d0edabe8f\``);
        await queryRunner.query(`ALTER TABLE \`budget_plans_items\` DROP FOREIGN KEY \`FK_7e21f7bc697977567a5eac4698d\``);
        await queryRunner.query(`ALTER TABLE \`budget_plans\` DROP FOREIGN KEY \`FK_aebc4d211ef6721235e3d6fb610\``);
        await queryRunner.query(`ALTER TABLE \`budget_plans\` DROP FOREIGN KEY \`FK_199873cfc22a78da747a84e6344\``);
        await queryRunner.query(`ALTER TABLE \`workflow_tasks\` DROP FOREIGN KEY \`FK_82c7dfd058f5a9942881237791e\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_6c2d15be4ed959824ad8c606da\` ON \`budget_plans_items\``);
        await queryRunner.query(`DROP TABLE \`budget_plans_items\``);
        await queryRunner.query(`DROP TABLE \`budget_plans\``);
        await queryRunner.query(`DROP INDEX \`IDX_b8b0e0dc9227302b7676194b49\` ON \`budget_calendars\``);
        await queryRunner.query(`DROP TABLE \`budget_calendars\``);
        await queryRunner.query(`DROP INDEX \`IDX_4cb7d4663a389456682a1c4f35\` ON \`chart_of_accounts\``);
