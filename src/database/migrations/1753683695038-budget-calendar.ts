...
export class BudgetCalendar1753683695038 implements MigrationInterface {
    name = 'BudgetCalendar1753683695038'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_a47abf14f7fcaa763ad41db89e\` ON \`budget_calendars\` (\`name\`, \`tenantId\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`organizational_units\` DROP FOREIGN KEY \`FK_54193628bff963be1903bff5326\``);
        await queryRunner.query(`ALTER TABLE \`organizational_units\` DROP FOREIGN KEY \`FK_86cd7f4f5d426d72204c544ac0f\``);
        await queryRunner.query(`DROP INDEX \`IDX_a47abf14f7fcaa763ad41db89e\` ON \`budget_calendars\``);
        await queryRunner.query(`DROP INDEX \`IDX_d7d5f894f7561851be91873123\` ON \`permission\``);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_b8b0e0dc9227302b7676194b49\` ON \`budget_calendars\` (\`name\`)`);
    }
