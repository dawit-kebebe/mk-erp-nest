...
export class UpdateOrganizationalUnit1751112062632 implements MigrationInterface {
    name = 'UpdateOrganizationalUnit1751112062632'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_4b93bf856fbf0717aa24b1076f\` ON \`organizational_units\` (\`name\`)`);
    }
