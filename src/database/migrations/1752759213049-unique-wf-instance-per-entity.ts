...
export class UniqueWfInstancePerEntity1752759213049 implements MigrationInterface {
    name = 'UniqueWfInstancePerEntity1752759213049'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_2a30bf767022c11b6616eef307\` ON \`workflow_instances\` (\`entityId\`, \`entityType\`, \`tenantId\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`organizational_units\` DROP FOREIGN KEY \`FK_54193628bff963be1903bff5326\``);
        await queryRunner.query(`ALTER TABLE \`organizational_units\` DROP FOREIGN KEY \`FK_86cd7f4f5d426d72204c544ac0f\``);
        await queryRunner.query(`DROP INDEX \`IDX_2a30bf767022c11b6616eef307\` ON \`workflow_instances\``);
