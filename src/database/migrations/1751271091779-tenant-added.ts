...
export class TenantAdded1751271091779 implements MigrationInterface {
    name = 'TenantAdded1751271091779'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`organizational_units\` ADD \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE \`organizational_units\` ADD \`updatedAt\` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`organizational_units\` ADD \`deletedAt\` timestamp(6) NULL`);
        await queryRunner.query(`ALTER TABLE \`organizational_units\` ADD \`tenantId\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`organizational_units\` DROP COLUMN \`tenantId\``);
        await queryRunner.query(`ALTER TABLE \`organizational_units\` DROP COLUMN \`deletedAt\``);
        await queryRunner.query(`ALTER TABLE \`organizational_units\` DROP COLUMN \`updatedAt\``);
        await queryRunner.query(`ALTER TABLE \`organizational_units\` DROP COLUMN \`createdAt\``);
    }
