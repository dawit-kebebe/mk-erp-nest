...
export class FixPermissionListWithUniqueFeatureTag1753107576674 implements MigrationInterface {
    name = 'FixPermissionListWithUniqueFeatureTag1753107576674'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_a65b58392316a70c5936c7649c\` ON \`permission\` (\`feature_tag\`)`);
    }
