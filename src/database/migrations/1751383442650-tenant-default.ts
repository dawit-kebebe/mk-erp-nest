...
export class TenantDefault1751383442650 implements MigrationInterface {
    name = 'TenantDefault1751383442650'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` CHANGE \`tenantId\` \`tenantId\` varchar(255) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`organizational_units\` CHANGE \`tenantId\` \`tenantId\` varchar(255) NOT NULL`);
