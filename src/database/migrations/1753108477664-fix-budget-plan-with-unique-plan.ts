...
export class FixBudgetPlanWithUniquePlan1753108477664 implements MigrationInterface {
    name = 'FixBudgetPlanWithUniquePlan1753108477664'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`workflow_tasks\` CHANGE \`actedByRoleId\` \`actedByRoleId\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`workflow_tasks\` CHANGE \`actionDate\` \`actionDate\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE \`workflow_tasks\` CHANGE \`comments\` \`comments\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`budget_calendars\` CHANGE \`createdAt\` \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE \`budget_calendars\` CHANGE \`deletedAt\` \`deletedAt\` timestamp(6) NULL`);
        await queryRunner.query(`ALTER TABLE \`budget_calendars\` CHANGE \`description\` \`description\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`budget_calendars\` CHANGE \`from\` \`from\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`budget_calendars\` CHANGE \`to\` \`to\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`chart_of_accounts\` CHANGE \`description\` \`description\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`budget_plans\` CHANGE \`createdAt\` \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE \`budget_plans\` CHANGE \`deletedAt\` \`deletedAt\` timestamp(6) NULL`);
        await queryRunner.query(`ALTER TABLE \`budget_plans_items\` CHANGE \`description\` \`description\` text NULL`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_d7d5f894f7561851be91873123\` ON \`permission\` (\`feature_tag\`, \`roleId\`)`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_e56a49777cb043790d9d8a3e15\` ON \`budget_plans_items\` (\`budgetPlanId\`, \`plan\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`organizational_units\` DROP FOREIGN KEY \`FK_54193628bff963be1903bff5326\``);
        await queryRunner.query(`ALTER TABLE \`organizational_units\` DROP FOREIGN KEY \`FK_86cd7f4f5d426d72204c544ac0f\``);
        await queryRunner.query(`DROP INDEX \`IDX_e56a49777cb043790d9d8a3e15\` ON \`budget_plans_items\``);
        await queryRunner.query(`DROP INDEX \`IDX_d7d5f894f7561851be91873123\` ON \`permission\``);
        await queryRunner.query(`ALTER TABLE \`budget_plans_items\` CHANGE \`description\` \`description\` text NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`budget_plans\` CHANGE \`deletedAt\` \`deletedAt\` timestamp(6) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`budget_plans\` CHANGE \`createdAt\` \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`chart_of_accounts\` CHANGE \`description\` \`description\` text NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`budget_calendars\` CHANGE \`to\` \`to\` timestamp NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`budget_calendars\` CHANGE \`from\` \`from\` timestamp NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`budget_calendars\` CHANGE \`description\` \`description\` text NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`budget_calendars\` CHANGE \`deletedAt\` \`deletedAt\` timestamp(6) NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`budget_calendars\` CHANGE \`createdAt\` \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE \`workflow_tasks\` CHANGE \`comments\` \`comments\` text NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`workflow_tasks\` CHANGE \`actionDate\` \`actionDate\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`workflow_tasks\` CHANGE \`actedByRoleId\` \`actedByRoleId\` varchar(255) NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_6c2d15be4ed959824ad8c606da\` ON \`budget_plans_items\` (\`plan\`)`);
    }
