...
* [Features](#bookmark=id.8lurfmljnc)  
* [Technologies](#bookmark=id.bz94yfnvjozc)  
* [Requirements](#bookmark=id.bmv183xl4ytt)  
* [Installation](#bookmark=id.pbymd5ad0tkj)  
* [Environment Variables](#bookmark=id.bcst05f35voc)  
* [Available Scripts](#bookmark=id.p2awd5ps9lc4)  
* [Documentation: How It Works](#bookmark=id.i15jsdg4vw4f)  
  * [Core Architectural Principles](#bookmark=id.9oxojr9d9f2o)  
  * [Organizational Units: The Flexible Hierarchy](#bookmark=id.my22wwcbezmv)  
  * [Multi-Tenancy: Root Organization as Tenant](#bookmark=id.dbvsn4hdxuga)  
  * [Roles, Permissions, and Access Control](#bookmark=id.ixkyhvsv2ox1)  
  * [Dynamic Workflows](#bookmark=id.6bgkxngq9myt)  
  * [Super Admin Functionality](#bookmark=id.q5oh627jun5e)  
  * [Ensuring Data Integrity: Cycle Detection](#bookmark=id.dc90w27met3)  
* [Future Enhancements](#bookmark=id.iciqzbr3ks0o)
...
* **Framework:** [NestJS](https://nestjs.com/) (Node.js framework for building efficient, scalable Node.js server-side applications)  
* **ORM:** [TypeORM](https://typeorm.io/)  
* **Database:** MySQL (Recommended), PostgreSQL (Alternative)  
* **Validation:** [Zod](https://zod.dev/) (for environment variables and DTOs)  
...
![Organizational Structure Example](./docs/images/org-hierarchy.svg)
...
![Multi-Tenancy Data Flow](./docs/images/multi-tenancy-dataflow.svg)
...
![Dynamic Workflow Process](./docs/images/dynamic-workflow-process.svg)
